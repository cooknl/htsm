...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{marimo-htsm/media/images/BigIdeaDiveCompare.png}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{marimo-htsm/media/images/BigIdeaStaticGiven.png}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{marimo-htsm/media/images/BigIdeaStaticCalculate.png}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{./marimo-htsm/media/images/BigIdeaStaticAngles.png}
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, titlerule=0mm, toptitle=1mm, rightrule=.15mm, leftrule=.75mm, opacityback=0, breakable, left=2mm, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-important-color-frame, toprule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, arc=.35mm, coltitle=black]
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{marimo-htsm/media/images/BigIdeaStaticCalculatePerfect.png}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{./marimo-htsm/media/images/BigIdeaStaticOtherAngles.png}
...
Focused & 8 \textgreater{} t ≥ 4 & M\&S & Defined \& Documented &
In-Flight Buildup & Pilot & Low \\
Aided & 4 \textgreater{} t ≥ 2.5 & Best Available M\&S & Defined \&
Documented & Sim Rehearsal \& In-Flight Buildup & Backup for Pilot &
Low-Med \\
Redundantly Aided & 2.5 \textgreater{} t ≥ 1.5 & Best Available M\&S &
Defined \& Documented & Sim Rehearsal \& In-Flight Buildup & Two Backups
for Pilot \& Anticipatory Cueing Desired & Med-High \\
Cued Anticipation & 1.5 \textgreater{} t ≥ 0 & Best Available M\&S &
Defined \& Documented & Sim Rehearsal \& In-Flight Buildup & Two Backups
for Pilot \& Anticipatory Cueing Required & High \\
\end{longtable}
...
\begin{Shaded}
\begin{Highlighting}[]
\ImportTok{from}\NormalTok{ numpy }\ImportTok{import}\NormalTok{ arcsin, arctan, sqrt}
...
\KeywordTok{def}\NormalTok{ abort\_buffer(angle}\OperatorTok{=}\NormalTok{abort\_angle(), radius}\OperatorTok{=}\FloatTok{1.0}\NormalTok{, speed}\OperatorTok{=}\FloatTok{1.0}\NormalTok{, time}\OperatorTok{=}\FloatTok{4.0}\NormalTok{):}
    \ControlFlowTok{return} \BuiltInTok{float}\NormalTok{(time }\OperatorTok{*}\NormalTok{ speed }\OperatorTok{*}\NormalTok{ np.sin(angle) }\OperatorTok{+}\NormalTok{ radius }\OperatorTok{*}\NormalTok{ (}\DecValTok{1} \OperatorTok{{-}}\NormalTok{ np.cos(angle)))}
...
\KeywordTok{def}\NormalTok{ time\_margin(}\BuiltInTok{buffer}\OperatorTok{=}\FloatTok{4.0}\NormalTok{, radius}\OperatorTok{=}\FloatTok{1.0}\NormalTok{, speed}\OperatorTok{=}\FloatTok{1.0}\NormalTok{, angle}\OperatorTok{=}\NormalTok{abort\_angle()):}
    \ControlFlowTok{return} \BuiltInTok{float}\NormalTok{(}
\NormalTok{        (}\BuiltInTok{buffer} \OperatorTok{+}\NormalTok{ radius }\OperatorTok{*}\NormalTok{ (np.cos(angle) }\OperatorTok{{-}} \DecValTok{1}\NormalTok{)) }\OperatorTok{/}\NormalTok{ (speed }\OperatorTok{*}\NormalTok{ np.sin(angle))}
\NormalTok{    )}
...
\KeywordTok{def}\NormalTok{ abort\_speed(}\BuiltInTok{buffer}\OperatorTok{=}\FloatTok{4.0}\NormalTok{, radius}\OperatorTok{=}\FloatTok{1.0}\NormalTok{, angle}\OperatorTok{=}\NormalTok{abort\_angle(), time}\OperatorTok{=}\FloatTok{4.0}\NormalTok{):}
    \ControlFlowTok{return} \BuiltInTok{float}\NormalTok{(}
\NormalTok{        (}\BuiltInTok{buffer} \OperatorTok{+}\NormalTok{ radius }\OperatorTok{*}\NormalTok{ (np.cos(angle) }\OperatorTok{{-}} \DecValTok{1}\NormalTok{)) }\OperatorTok{/}\NormalTok{ (time }\OperatorTok{*}\NormalTok{ np.sin(angle))}
\NormalTok{    )}
...
\KeywordTok{def}\NormalTok{ abort\_radius(}\BuiltInTok{buffer}\OperatorTok{=}\FloatTok{4.0}\NormalTok{, angle}\OperatorTok{=}\NormalTok{abort\_angle(), speed}\OperatorTok{=}\FloatTok{1.0}\NormalTok{, time}\OperatorTok{=}\FloatTok{4.0}\NormalTok{):}
    \ControlFlowTok{return} \BuiltInTok{float}\NormalTok{((time }\OperatorTok{*}\NormalTok{ speed }\OperatorTok{*}\NormalTok{ np.sin(angle) }\OperatorTok{{-}} \BuiltInTok{buffer}\NormalTok{) }\OperatorTok{/}\NormalTok{ (np.cos(angle) }\OperatorTok{{-}} \DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
